...
const MyPage = ({ member }) => {
  ...
  const [photoUrl, setPhotoUrl] = useState(member.photo ? getThumbnail(member.photo) : undefined);
  const { register, setValue, getValues, handleSubmit, errors, trigger } = useForm({
    defaultValues: {
  ...
  const onSubmitData = useCallback(
    handleSubmit(async ({ confirmMobile, confirmPassword, changePassword, notifyYn, sno, ...formData }) => {
          ...
          <FormTable>
            ...
            <tbody>
                ...
                <td colSpan={3}>
                  <BoxWrap>
                    ...
                    <InputBox>
                      ...
                      <ProfileInput type="file" id="thumbAdd" onChange={onChangeFile} />
                      <BlueButton
                        type="button"
                        onClick={(e) => {
                      ...
                      <ProfileDeleteBtn type="button" onClick={onDeleteProfileClick}>
                        삭제
                      </ProfileDeleteBtn>
                    </InputBox>
                  </BoxWrap>
              ...
              <tr>
                ...
                <td>
                  <BoxWrap>
                    <input type="password" autoComplete="new-password" ref={register} name="changePassword" />
                  </BoxWrap>

                  {errors?.changePassword && <ErrorMessage>{errors.changePassword.message}</ErrorMessage>}
                </td>
                <th>비밀번호 수정 확인</th>
                <td>
                  <BoxWrap>
                    <input type="password" autoComplete="new-password" ref={register} name="confirmPassword" />
                  </BoxWrap>
                </td>
              </tr>
              <tr>
                ...
                <td colSpan={3}>
                  <BoxWrap>
                    <input type="checkbox" id="agree01" ref={register} name="notifyYn" value="Y" />
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <BoxWrap>
                        <input type="text" ref={register} name="confirmMobile" readOnly />
