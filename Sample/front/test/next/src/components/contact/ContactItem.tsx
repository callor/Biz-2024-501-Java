...
import { useFieldArray, useForm } from "react-hook-form/dist/index.ie11";
...
const Mark = styled.td`
  input[type="checkbox"] {
    ...
    + label {
      ...
      width: 14px;
      height: 14px;
      background: url("/images/ico/ico_star_off.png") center no-repeat;
    }
    &:checked + label {
      background: url("/images/ico/ico_star_on.png") center no-repeat;
    }
  }
`;
