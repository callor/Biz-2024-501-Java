...
export const resetCss = css`
  ...
  video {
    ...
    border: 0;
    font-size: 100%;
    font-family: "Noto Sans KR", "Noto Sans JP", -apple-system,
      BlinkMacSystemFont, "Malgun Gothic", "맑은 고딕", helvetica,
  ...
  .checkbox_basic input[type="checkbox"] {
    display: none;
    width: 0;
    height: 0;
  }
  .checkbox_basic input[type="checkbox"] + label {
  ...
  .checkbox_basic input[type="checkbox"]:checked + label {
