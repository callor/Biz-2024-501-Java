...
export class IcUsr {
  ...
  @OneToOne(() => IcMember, (member) => member.user)
  @JoinColumn({ name: 'USER_ID' })
  member: IcMember;

  @OneToMany(() => IcUsrRole, (userRole) => userRole.user)
  roles: IcUsrRole[];

  @OneToMany(() => IcKpConnect, (connect) => connect.user)
  connects: IcKpConnect[];

  @OneToMany(() => IcContact, (contact) => contact.user)
  contacts: IcContact[];

  @OneToMany(() => IdCalendarUsr, (calendar) => calendar.user)
